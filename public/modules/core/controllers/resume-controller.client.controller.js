...
angular.module('core').controller('ResumeControllerController', ['$scope', '$window', 'd3', 'Dataobjects',
	function($scope, $window, d3, Dataobjects) {
		...
		// var D3Resume = Resume.getResumeObject();
		// console.log('D3resume', D3resume);
